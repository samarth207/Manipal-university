...
const COUNTRY_CODES = [
  ...
  ['+61','Australia'],['+971','UAE'],['+65','Singapore'],['+60','Malaysia'],
  ['+966','Saudi Arabia'],['+974','Qatar'],['+968','Oman'],['+973','Bahrain'],['+965','Kuwait'],
  ['+92','Pakistan'],['+880','Bangladesh'],['+94','Sri Lanka'],['+977','Nepal'],
  ['+93','Afghanistan'],['+995','Georgia'],['+994','Azerbaijan'],['+374','Armenia'],
  ['+998','Uzbekistan'],['+996','Kyrgyzstan'],['+992','Tajikistan'],['+993','Turkmenistan'],
  ['+7','Russia / Kazakhstan'],['+86','China'],['+81','Japan'],['+82','South Korea'],
  ['+66','Thailand'],['+62','Indonesia'],['+63','Philippines'],['+84','Vietnam'],
  ['+95','Myanmar'],['+856','Laos'],['+855','Cambodia'],['+673','Brunei'],
  ['+64','New Zealand'],['+679','Fiji'],['+675','Papua New Guinea'],
  ['+27','South Africa'],['+20','Egypt'],['+234','Nigeria'],['+254','Kenya'],
  ['+233','Ghana'],['+213','Algeria'],['+212','Morocco'],['+216','Tunisia'],
  ['+218','Libya'],['+249','Sudan'],['+251','Ethiopia'],['+255','Tanzania'],
  ['+256','Uganda'],['+260','Zambia'],['+263','Zimbabwe'],['+250','Rwanda'],
  ['+230','Mauritius'],['+237','Cameroon'],['+225','Ivory Coast'],['+221','Senegal'],
  ['+243','DR Congo'],['+258','Mozambique'],['+267','Botswana'],['+264','Namibia'],
  ['+261','Madagascar'],['+252','Somalia'],
  ['+49','Germany'],['+33','France'],['+34','Spain'],['+39','Italy'],
  ['+31','Netherlands'],['+41','Switzerland'],['+43','Austria'],['+32','Belgium'],
  ['+46','Sweden'],['+47','Norway'],['+45','Denmark'],['+358','Finland'],
  ['+353','Ireland'],['+351','Portugal'],['+48','Poland'],['+420','Czech Republic'],
  ['+36','Hungary'],['+30','Greece'],['+90','Turkey'],['+380','Ukraine'],
  ['+40','Romania'],['+359','Bulgaria'],['+385','Croatia'],['+381','Serbia'],
  ['+386','Slovenia'],['+421','Slovakia'],['+370','Lithuania'],['+371','Latvia'],['+372','Estonia'],
  ['+55','Brazil'],['+52','Mexico'],['+54','Argentina'],['+56','Chile'],['+57','Colombia'],
  ['+51','Peru'],['+593','Ecuador'],['+591','Bolivia'],['+595','Paraguay'],['+598','Uruguay'],
  ['+58','Venezuela'],['+502','Guatemala'],['+503','El Salvador'],['+504','Honduras'],
  ['+505','Nicaragua'],['+506','Costa Rica'],['+507','Panama'],['+53','Cuba'],
  ['+1876','Jamaica'],['+1868','Trinidad and Tobago'],['+1809','Dominican Republic'],
  ['+961','Lebanon'],['+962','Jordan'],['+964','Iraq'],['+972','Israel'],
  ['+963','Syria'],['+967','Yemen'],['+976','Mongolia']
];

function initCCSelects() {
  document.querySelectorAll('.cc-select').forEach(function(sel) {
    if (sel.options.length > 0) return;
    COUNTRY_CODES.forEach(function(c) {
      const o = document.createElement('option');
      o.value = c[0];
      o.textContent = c[1] + ' (' + c[0] + ')';
      if (c[0] === '+91' && c[1] === 'India') o.selected = true;
      sel.appendChild(o);
    });
  });
}
...
if (document.readyState === 'loading') {
  document.addEventListener('DOMContentLoaded', initCCSelects);
} else {
  initCCSelects();
}
